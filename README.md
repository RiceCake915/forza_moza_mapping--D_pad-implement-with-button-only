...
Only edited the Moza R5 config for D_pad *InputType* from switch to button, as I cannot get the original to work with switch InputType to have the d_pad icon on Anna and Link function.
